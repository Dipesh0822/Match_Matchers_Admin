              ...
              <Grid item xs={12}>
                ...
                >
                  ...
                  <Grid item>
                    ...
                    >
                      <MenuItem onClick={() => handleDateChange("today")}>
                        Today
                      </MenuItem>
                      <MenuItem onClick={() => handleDateChange("month")}>
                        Month
                      </MenuItem>
                      <MenuItem onClick={() => handleDateChange("year")}>
                        Year
                      </MenuItem>
                      <Divider />
                      <MenuItem onClick={() => handleDateChange("custom")}>
                        Custom
                      </MenuItem>
                    </Menu>
                  </Grid>
